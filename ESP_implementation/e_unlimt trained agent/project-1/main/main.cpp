...
void inference_task(void *arg)
{
    ...
    // Variables for inference and control
    float th, vel,prev_th,de,tank, delta_theta,pos_err;
    float dt;
    float best_action,prev_best_action = 0;
    uint16_t dutyCycle;
    signal_t obs;
...
extern "C" void app_main(void) //extern "C" perchè il compilatore C++ manda in errore la funzione main
{
